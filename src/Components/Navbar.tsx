...
function Navbar() {
  return (
    ...
    <NavLink to='/about' className={({isActive})=> isActive?'font-bold underline underline-offset-8':'font-medium'}>About</NavLink>
    <NavLink to='/vans' className={({isActive})=> isActive?'font-bold underline underline-offset-8':'font-medium'}>Vans</NavLink>
    </nav>
    </header>
  )
}
